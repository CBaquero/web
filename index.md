...
I am a Professor in the [Department of Informatics Engineering](https://sigarra.up.pt/feup/en/uni_geral.unidade_view?pv_unidade=151) within [FEUP](https://sigarra.up.pt/feup/en/web_page.inicial), and area coordinator at the High Assurance Laboratory (HASLab) within [INESC TEC](http://www.inestec.pt).
...
* **PaPoC**. Steering committee of the workshop series on Principles and Practice of Consistency for Distributed Data, regularly hosted with [EuroSys](http://www.eurosys.org). [PaPoC'21](https://dl.acm.org/doi/proceedings/10.1145/3447865),[PaPoC'20](https://dl.acm.org/doi/proceedings/10.1145/3380787),...
